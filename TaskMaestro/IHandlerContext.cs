...
{
    Task<TAckValue> GetAckValueByType<TAckValue>(CancellationToken cancellationToken);
    ...
    Task<(TAckValue1, TAckValue2, TAckValue3, TAckValue4)>
        GetAckValuesByTypes<TAckValue1, TAckValue2, TAckValue3, TAckValue4>(CancellationToken cancellationToken);

    Task<(TAckValue1, TAckValue2, TAckValue3)>
        GetAckValuesByTypes<TAckValue1, TAckValue2, TAckValue3>(CancellationToken cancellationToken);

    Task<(TAckValue1, TAckValue2)>
        GetAckValuesByTypes<TAckValue1, TAckValue2>(CancellationToken cancellationToken);
}
